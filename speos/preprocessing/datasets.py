...
class MultiGeneDataset(GeneDataset):
    def __init__(self, name, config, holdout_size: float = 0.05, transform=None, pre_transform=None):
        super().__init__(name, config, holdout_size, transform, pre_transform)
