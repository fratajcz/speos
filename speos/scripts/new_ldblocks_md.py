...
checker = LDBlockChecker(snpfile="/mnt/storage/prs/ldblocks/MD/MD_sign_snps.tsv")

checker.build_ldblocks()
checker.build_genes()
checker.build_snps()
checker.build_coregenes("/mnt/storage/speos/results/md_film_nohetioouter_results.json", cs=1)

mendelians = preprocess_labels("/home/ubuntu/speos/extensions/md_only_genes.tsv")
...
table.to_csv("MD_only_ldblocks_by_snps.tsv", sep="\t")
print(array)
