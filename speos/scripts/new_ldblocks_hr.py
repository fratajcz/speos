...
checker = LDBlockChecker(snpfile="/mnt/storage/prs/ldblocks/HR/HR_sign_snps.bed")

checker.build_ldblocks()
checker.build_genes()
checker.build_snps()
checker.build_coregenes("/mnt/storage/speos/results/hr_film_nohetioouter_results.json", cs=1)

mendelians = preprocess_labels("/home/ubuntu/speos/extensions/hr_only_genes.tsv")
...
table.to_csv("HR_only_ldblocks_by_snps.tsv", sep="\t")
print(array)
